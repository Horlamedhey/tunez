                    ...
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <div class="banner-content">
                                ...
                                <p>
                                    Tunez app is the first crypto app to combine three separate mainstream industries in one piece.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 offset-md-1 wow fadeInUp" data-wow-duration="2s">
                                <div class="blockcain-top-content">
                                    <p>
                                        We are appealing to people to use cryptocurrencies through what they like doing best.
                                    </p>
            ...
            <div class="container">
                ...
                <div class="row mb-3">
                    <div class="col-md-6 wow fadeInUp " data-wow-duration="1.5s">
                        ...
                        <p><a class="navSidebar-button-reg btn-sm btn-secondary text-white" style="cursor: pointer;">Join the Airdrop Campaign Here.</a></p>
                    </div><!-- col end -->
                    <div class="col-md-6 wow fadeInUp " data-wow-duration="1.5s">
